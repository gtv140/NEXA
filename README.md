...
input,select,button{width:100%;padding:10px;margin-top:10px;border-radius:8px;border:none;background:rgba(255,255,255,0.1);color:var(--white);}
button{cursor:pointer;background:linear-gradient(90deg,var(--gold),var(--red));font-weight:700;color:var(--black);}
