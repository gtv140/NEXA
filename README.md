...
.slide-container{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;gap:10px;}
.slide-container::-webkit-scrollbar{display:none;}
.slide-box{min-width:220px;flex-shrink:0;background:var(--box);padding:15px;border-radius:12px;scroll-snap-align:start;}
</style>
</head>
<body>
